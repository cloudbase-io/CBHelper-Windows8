...
/*! \mainpage cloudbase.io Windows 8 Helper Class Reference
*
...
*/
    ...
    public class CBHelper
    {
        ...
        private void RegisterDevice()
        {
            ...
            values.Add("language", region.Code);
            values.Add("country", region.CodeTwoLetter);
        ...
        private void prepareParameters(Stream sw, object postData, Dictionary<string, string> additionalParameters, List<CBHelperAttachment> files)
        {
            ...
            if (this.CurrentLocation != null)
            {
                ...
                location.Add("lat", Convert.ToString(this.CurrentLocation.Coordinate.Latitude));
                location.Add("lng", Convert.ToString(this.CurrentLocation.Coordinate.Longitude));
                location.Add("alt", Convert.ToString(this.CurrentLocation.Coordinate.Altitude));
